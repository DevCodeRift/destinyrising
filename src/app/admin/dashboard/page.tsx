          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <h4 className="text-sm font-medium text-gray-900">Add New Item</h4>
                  <p className="text-sm text-gray-500">Create a new weapon, armor, or artifact</p>
                </div>
              </div>
            </Link>
            ...
            >
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-sm text-gray-500">Organize items into categories</p>
                </div>
              </div>
            </Link>

            <button className="block w-full p-4 border border-gray-200 rounded-lg hover:border-purple-300 hover:shadow-md transition-all duration-200">
              <div className="flex items-center">
                <div className="flex-shrink-0">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-sm text-gray-500">Bulk import items from CSV/JSON</p>
                </div>
              </div>
            </button>
          </div>
